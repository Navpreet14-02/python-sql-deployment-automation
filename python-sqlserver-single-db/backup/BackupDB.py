...
def BackupDB(server_name,database,username,password):
    connection_string = f"Driver={{SQL Server}};Server=tcp:{server_name},1433;Database={database};Uid={username};Pwd={password};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
    try:
